...
```bash
# Management Commands（推荐）
docker container stats boring_kepler

# Commands
docker stats boring_kepler
```
...
默认会在前台启动，输出会打印在用户终端，用户终端退出，容器退出，如图所示：

![image-20230420221315926](images/DockerContainer/image-20230420221315926.png)
